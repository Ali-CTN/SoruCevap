...
import com.example.SinavSavaslari.Interface.RankingCallBack;
import com.example.SinavSavaslari.Model.QuestionScore;
import com.example.SinavSavaslari.Model.Ranking;
import com.example.SinavSavaslari.ViewHolder.RankingViewHolder;
...
public class RankingFragment extends Fragment {
    ...
    public static RankingFragment newInstence(){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        questionScore = database.getReference("Soru_Puan");
        rankingTbl = database.getReference("Sıralama");
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Firebase küçükten büyüğe sıralar burada ters çeviriyoruz.
